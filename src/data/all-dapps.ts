...
const categories = [
  {
    ...
    displayIos: false,
    icon: "./images/categories/africa.png",
    color: "#E5F7DB",
    iconColor: "#A1D186",
    dapps: [
      {
        ...
        icon: "./images/dapps/humaniq-bot.png",
        title: "@humaniqID_bot",
        isBSC: true,
        isEth: false,
      },
      ...
      },
      {
        ...
        icon: "./images/dapps/one-dollar.png",
        isBSC: true,
        isEth: false,
      },
      {
        ...
        icon: "./images/dapps/humaniq-id.png",
        isBSC: true,
        isEth: false,
      },
      {
      ...
      },
      {
        ...
        icon: "./images/dapps/etherscan.png",
        isBSC: false,
        isEth: true,
      },
    ],
  ...
  },
  {
    ...
    dapps: [
      ...
      },
      {
        ...
        icon: "./images/dapps/localbitcoins.png",
        isBSC: true,
        isEth: true,
      },
    ],
  },
  {
    ...
    dapps: [
      ...
      },
      {
        ...
        description: "Track the prices and rankings of crypto assets",
        icon: "./images/dapps/defipulse.png",
        isBSC: true,
        isEth: true,
      },
    ],
